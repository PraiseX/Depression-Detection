...
# #joblib.dump(clf, "SVM model Linear") 
# clf2 = joblib.load("SVM Model")
# print("SVM model loaded")
# predictionSVM = clf2.predict(au_file_test_transformed)  
...
# predictprobSVM = clf2._predict_proba_lr(au_file_test)
...
joblib.dump(xgb_model, "XGB Classifier Model") 
...
predictprobXGB = xgb_model.predict_proba(au_file_test)
